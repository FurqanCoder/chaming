...
<head>
    ...
    <title>Home-Charming Flow</title>
    <script src="../../cdn-cgi/apps/head/2oc_RD5SS6wgN5SiQnSEnWVNHg8.js"></script>
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <link rel="icon" href="{{ asset('web/images/others/favicon.ico') }}">
    <link rel="stylesheet" href="{{ asset('web/vendors/lightgallery/css/lightgallery-bundle.min.css') }}">
    <link rel="stylesheet" href="{{ asset('web/vendors/fontawesome/css/all.min.css') }}">
    <link rel="stylesheet" href="{{ asset('web/vendors/animate/animate.min.css') }}">
    <link rel="stylesheet" href="{{ asset('web/vendors/slick/slick.css') }}">
    <link rel="stylesheet" href="{{ asset('web/css/custom.css') }}">
    <link rel="stylesheet" href="{{ asset('web/vendors/mapbox-gl/mapbox-gl.min.css') }}">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css" />
    <link
        href="https://fonts.googleapis.com/css2?family=Urbanist:wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap"
        rel="stylesheet" />
    <link
        href="../../css2?family=Urbanist:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&amp;display=swap"
        rel="stylesheet">
...
<body>
        ...
        <div class="sticky-area">
            <div class="main-header nav navbar bg-body navbar-light navbar-expand-xl py-6 py-xl-0">
                <div class="container-wide container flex-nowrap">
                        ...
                        <ul class="navbar-nav">
                            <li
                                ...
                                <a class="nav-link d-flex justify-content-between position-relative py-0 px-0 text-uppercase fw-semibold ls-1 fs-14px dropdown-toggle"
                                    href="index.html" data-bs-toggle="dropdown" id="menu-item-home" aria-haspopup="true"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col d-xxl-block d-none megamenu-shop-banner"
                                                ...
                                                <div class="card border-0 mt-4">
                                                    <img src="web/images/background/bg-mega-menu-shop.jpg"
                    ...
                    <a href="home-01.html" class="navbar-brand px-8 py-4 mx-auto">
                        <img class="light-mode-img" src="{{ asset('web/images/others/logo.png') }}" width="179"
                            height="26" alt="Glowing - Bootstrap 5 HTML Templates" />
                        <img class="dark-mode-img" src="{{ asset('web/images/others/logo-white.png') }}"
                    ...
                    <div class="icons-actions d-flex justify-content-end w-xl-50 fs-28px text-body-emphasis">
                        ...
                        <div class="px-5 d-none d-xl-inline-block">
                            <a class="lh-1 color-inherit text-decoration-none" href="{{ route('web-login') }}">
                        ...
                        <div class="px-5 d-none d-xl-inline-block">
                            <a class="position-relative lh-1 color-inherit text-decoration-none" href="#"
                                ...
                                <span
                                    class="badge bg-dark text-white position-absolute top-0 start-100 translate-middle mt-4 rounded-circle fs-13px p-0 square"
                                    id="card-count" style="--square-size: 18px">
        ...
        <div class="container container-xxl pt-4">
            <div class="row">
                <div class="col-lg col-md-4 col-12 mb-11 mb-lg-0 fs-14px">
                    ...
                    <p class="pe-xl-18 lh-2">
                        ...
                        <a class="" href="#"><u class="fw-medium">Our Stores</u></a>
                    </p>
                    <p class="mb-0 lh-2">
            ...
            <div class="row align-items-center mt-0 mt-lg-20 pt-lg-4">
                ...
                <div class="col-sm-12 col-lg-4 text-md-center order-1 order-lg-2">
                    <a class="d-inline-block" href="home-01.html">
                        <img class="lazy-image img-fluid light-mode-img" src="#"
                            data-src="./web/images/others/logo.png" width="179" height="26"
                            alt="Glowing - Bootstrap 5 HTML Templates" />
                        <img class="lazy-image dark-mode-img img-fluid" src="#"
                            data-src="./web/images/others/logo-white.png" width="179" height="26"
                            alt="Glowing - Bootstrap 5 HTML Templates" />
                    </a>
                </div>
                <div class="col-sm-12 col-md-6 col-lg-4 order-3 text-sm-start text-lg-end mt-8 mt-lg-0">
                    <img src="#" data-src="./web/images/footer/img_1.png" width="313" height="28"
    ...
    <script src="{{ asset('web/vendors/bootstrap/js/bootstrap.bundle.js') }}"></script>
    <script src="{{ asset('web/js/ajax.js') }}"></script>
    <script src="{{ asset('web/js/custom.js') }}"></script>
    <script src="{{ asset('web/vendors/clipboard/clipboard.min.js') }}"></script>
    <script src="{{ asset('web/vendors/vanilla-lazyload/lazyload.min.js') }}"></script>
    <script src="{{ asset('web/vendors/waypoints/jquery.waypoints.min.js') }}"></script>
    <script src="{{ asset('web/vendors/lightgallery/lightgallery.min.js') }}"></script>
    <script src="{{ asset('web/vendors/lightgallery/plugins/zoom/lg-zoom.min.js') }}"></script>
    <script src="{{ asset('web/vendors/lightgallery/plugins/thumbnail/lg-thumbnail.min.js') }}"></script>
    <script src="{{ asset('web/vendors/lightgallery/plugins/video/lg-video.min.js') }}"></script>
    <script src="{{ asset('web/vendors/lightgallery/plugins/vimeoThumbnail/lg-vimeo-thumbnail.min.js') }}"></script>
    <script src="{{ asset('web/vendors/isotope/isotope.pkgd.min.js') }}"></script>
    <script src="{{ asset('web/vendors/slick/slick.min.js') }}"></script>
    <script src="{{ asset('web/vendors/gsap/gsap.min.js') }}"></script>
    <script src="{{ asset('web/vendors/gsap/ScrollToPlugin.min.js') }}"></script>
    <script src="{{ asset('web/vendors/gsap/ScrollTrigger.min.js') }}"></script>
        ...
        <div class="container-wide container-xxl">
            <nav class="navbar navbar-expand-xl px-0 py-6 py-xl-12 row align-items-start">
                <div class="col-xl-3 d-flex justify-content-center justify-content-xl-start">
                    <a href="home-01.html" class="navbar-brand py-4 d-lg-inline-block">
                        <img src="web/images/others/logo.png" height="26"
                            alt="Glowing - Bootstrap 5 HTML Templates" />
                    </a>
                </div>
    ...
    <div id="shoppingCart" data-bs-scroll="false" class="offcanvas offcanvas-end">
                    ...
                    <thead>
                        <tr class="fw-500">
                            <td colspan="3" class="border-bottom pb-6">
                                ...
                                Your cart is saved for the next time you visit
                            </td>
                            <td class="border-bottom text-end pb-6">
                        ...
                        {{-- <tr class="position-relative">
                            ...
                            <td class="shop-product">
                                <div class="d-flex align-items-center">
                                    <div class="me-6">
                                        <img src="{{asset('web/uploads/product/1703069904_product-04-330x440.jpg')}}" width="60" height="80"
        ...
        <div class="offcanvas-footer flex-wrap">
            <div class="d-flex align-items-center justify-content-between w-100 mb-5">
                ...
                <span class="cart-total fw-bold text-body-emphasis" id="card-total"></span>
            </div>
            <a href="../shop/checkout.html" class="btn btn-dark w-100 mb-7" title="Check Out">Check Out</a>
            <a href="../shop/shopping-cart.html" class="btn btn-outline-dark w-100"
                title="View shopping cart">View
                shopping cart</a>
        </div>
    </div>
                ...
                <div class="modal-body px-sm-13 px-8">
                    ...
                    <p class="text-center fs-16 mb-10">
                        ...
                        <a href="#" data-bs-toggle="modal" data-bs-target="#signInModal"
                            class="text-black">Log in</a>
                    </p>
                    <form id="registrationForm" action="" method="post">
                        @csrf
                        <input name="name" type="text" class="form-control border-1 mb-5"
                            placeholder="First name" required="" />
                        <input name="email" type="email" class="form-control border-1 mb-5"
                            placeholder="Your email" required="" />
                        <input name="password" type="password" class="form-control border-1 mb-5"
                            placeholder="Password" required="" />
                        {{-- <input name="confirm-password" type="password" class="form-control border-1 " placeholder="Confirm Password"
                            required="" /> --}}
                ...
                <div class="modal-body pt-0">
                    <div class="row">
                        <div class="col-md-6 pe-13">
                            <div class="position-relative">
                                ...
                                <div id="slider"
                                    ...
                                    <a href="web/images/shop/product-gallery-05.jpg" data-gallery="gallery1"><img
                                            src="#" data-src="./web/images/shop/product-gallery-05.jpg"
                                            class="h-auto lazy-image" width="540" height="720"
                                            alt="" /></a>
                                    <a href="web/images/shop/product-gallery-06.jpg" data-gallery="gallery1"><img
                                            src="#" data-src="./web/images/shop/product-gallery-06.jpg"
                                            class="h-auto lazy-image" width="540" height="720"
                                            alt="" /></a>
                                    <a href="web/images/shop/product-gallery-07.jpg" data-gallery="gallery1"><img
                                            src="#" data-src="./web/images/shop/product-gallery-07.jpg"
                                            class="h-auto lazy-image" width="540" height="720"
                                            alt="" /></a>
                                    <a href="web/images/shop/product-gallery-08.jpg" data-gallery="gallery1"><img
                                            src="#" data-src="./web/images/shop/product-gallery-08.jpg"
                                            class="h-auto lazy-image" width="540" height="720"
                                            alt="" /></a>
                                </div>
                            </div>
                            <div class="mt-6">
                                <div id="slider-thumb" class="slick-slider slick-slider-thumb ps-1 ms-n3 me-n4"
                                    ...
                                    <img src="#" data-src="./web/images/shop/product-gallery-05-154x205.jpg"
                                        class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75"
                                        height="100" alt="" />
                                    <img src="#" data-src="./web/images/shop/product-gallery-06-154x205.jpg"
                                        class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75"
                                        height="100" alt="" />
                                    <img src="#" data-src="./web/images/shop/product-gallery-07-154x205.jpg"
                                        class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75"
                                        height="100" alt="" />
                                    <img src="#" data-src="./web/images/shop/product-gallery-08-154x205.jpg"
                                        class="mx-3 px-0 h-auto cursor-pointer lazy-image" width="75"
                                        height="100" alt="" />
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 pt-md-0 pt-10">
                            ...
                            <p class="fs-15px">
                                Niacinamide and Vitamin C are two anti-aging superstars but
                                not usually formulated together because of their different pH
                                levels.
                            </p>
                            <p class="mb-4 pb-2">
                            ...
                            <div class="card border-0 bg-body-tertiary rounded text-center mt-7">
                                <div class="pt-8 px-5">
                                    <img class="img-fluid" src="web/images/shop/product-info-2.png" alt="pay"
                                        width="357" height="28" />
                                </div>
            ...
            <div class="offcanvas-body pt-0 mb-2">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item transition-all-xl-1 py-0 dropdown">
                        <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle"
                            href="#" data-bs-toggle="dropdown" id="menu-item-pages-canvas"
                            aria-haspopup="true" aria-expanded="false">Pages</a>
                    ...
                    <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                        <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle"
                            href="#" data-bs-toggle="dropdown" id="menu-item-blocks-canvas"
                            aria-haspopup="true" aria-expanded="false">Blocks</a>
                    ...
                    <li class="nav-item transition-all-xl-1 py-0 dropdown dropdown-fullwidth">
                        <a class="nav-link d-flex justify-content-between position-relative text-uppercase fw-semibold ls-1 fs-15px dropdown-toggle"
                            href="#" data-bs-toggle="dropdown" id="menu-item-docs-canvas"
                            aria-haspopup="true" aria-expanded="false">Docs</a>
    ...
    <div class="position-fixed z-index-10 bottom-20 end-0 p-10">
        <a href="#"
            class="gtf-back-to-top text-decoration-none bg-body text-primary bg-primary-hover text-light-hover shadow square p-0 rounded-circle d-flex align-items-center justify-content-center"
            title="Back To Top" style="--square-size: 48px"><i class="fa-solid fa-arrow-up"></i></a>
    </div>
    {{-- chatbot --}}
    <!-- Chat icon -->
    <x-layout.chat-component/>
    <script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js"></script>
    <script src="https://code.jquery.com/jquery-3.7.1.min.js" defer></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/emojionearea/3.4.2/emojionearea.min.js" defer></script>

    <livewire:scripts />
</body>
<script>
    // Include this script in your Blade view or in your web
