...
<head>
    ...
    <title>Dashboard | Charming Flow</title>
    
    <link rel="shortcut icon" href="favicon.png">
    <link rel="stylesheet" href="{{asset('dashboad/assets/vendor/css/all.min.css')}}">
    <link rel="stylesheet" href="{{asset('dashboad/assets/vendor/css/sharp-solid.min.css')}}">
    <link rel="stylesheet" href="{{asset('dashboad/assets/vendor/css/dropzone.min.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('dashboad/assets/vendor/css/select2.min.css')}}">
    <link rel="stylesheet" href="{{asset('dashboad/assets/vendor/css/bootstrap-material-datetimepicker.css')}}">
    <link rel="stylesheet" href="{{asset('dashboad/assets/vendor/css/material-icon.css')}}">
    <link rel="stylesheet" href="{{asset('dashboad/assets/vendor/css/selectize.css')}}">

    <link rel="stylesheet" href="{{asset('dashboad/assets/vendor/css/daterangepicker.css')}}">
    <link rel="stylesheet" href="{{asset('dashboad/assets/vendor/css/jquery.uploader.css')}}">
    ...
    <link rel="stylesheet" id="primaryColor" href="{{asset('dashboad/assets/css/custom.css')}}">
...
<script src="{{asset('dashboad/assets/vendor/js/dropzone.min.js')}}"></script>
<script src="{{asset('dashboad/assets/js/dropzone-init.js')}}"></script>
...
<script src="{{asset('dashboad/assets/vendor/js/bootstrap-material-datetimepicker.js')}}"></script>
<script src="{{asset('dashboad/assets/vendor/js/daterangepicker.js')}}"></script>
<script src="{{asset('dashboad/assets/vendor/js/select2.min.js')}}"></script>
<script src="{{asset('dashboad/assets/vendor/js/selectize.min.js')}}"></script>
<script src="{{asset('dashboad/assets/js/select2-init.js')}}"></script>
<script src="{{asset('dashboad/assets/js/add-product.js')}}"></script>
<script src="{{asset('dashboad/assets/js/category.js')}}"></script>
<script src="{{asset('dashboad/assets/vendor/js/jquery.dataTables.min.js')}}"></script>
<script src="{{asset('dashboad/assets/vendor/js/ckeditor.js')}}"></script>
<script src="{{asset('dashboad/assets/vendor/js/jquery.uploader.min.js')}}"></script>
...
<script src="{{asset('dashboad/assets/js/my.js')}}"></script>
