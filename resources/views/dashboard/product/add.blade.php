...
@section('dash-content')
    ...
    <div class="main-content">
        ...
        <form action="{{ route('add-product') }}" id="yourFormId" method="post" enctype="multipart/form-data">
            @csrf
            @if ($errors->any())
                        ...
                        <div class="panel-body product-title-input">
                            ...
                            <p class="perma-txt" hidden>
                                Permalink: <span data-link="https://example.com/" class="site-link text-primary"
                                    ...
                                    class="form-control form-control-sm" hidden id="editPermalink" name="slug">
                    ...
                    <div class="panel mb-30">
                        <div class="panel-header">
                            ...
                            <div class="btn-box d-flex gap-2">
                                <a href="javascript:void(0)" class="btn btn-sm btn-outline-primary" id="generate">Generate</a>
                                
                            </div>
                        </div>
                        <div class="panel-body">
                            <textarea class="myTextarea" name="description" id="responsetext" ></textarea>
                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="end_data"
                                                    class="form-control form-control-sm dateRangePicker" id="PriceDateEnd"
                                ...
                                <div class="tab-pane fade" id="nav-productDetails" role="tabpanel"
                                    ...
                                    <div class="add-product-attribute">
                                            ...
                                            <div class="panel mb-30">
                                                ...
                                                <div class="panel-body">
                                                    <textarea class="editor myTextarea" name="product_details"></textarea>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="nav-shipping-info" role="tabpanel"
                                    aria-labelledby="nav-shipping-info-tab" tabindex="0">
                                        ...
                                        <div class="panel mb-30">
                                            ...
                                            <div class="panel-body">
                                                <textarea class="editor myTextarea" name="use"></textarea>
                                            </div>
                                        </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <div class="product-tag-area">
                                <div class="row g-3">
                                    <div class="col-11">
                                        <input type="text" name="tags" class="input-flush" id="productTags"
        ...
        <script>
           ...
           document.addEventListener("DOMContentLoaded", function() {
               ClassicEditor
                   ...
                   .then(editor => {
                       ...
                       // editor.setData('hello world'); // You may or may not need this, depending on your requirements
                   })
                   .catch(error => {
           ...
           $('#generate').click(function(){
               var name = document.getElementById('productTitle').value;
               var csrfToken = $('meta[name="csrf-token"]').attr('content'); // Fetch CSRF token
               var dataToSend = {
                   _token: csrfToken, // Include CSRF token in the data
                   name: name // Use 'name' instead of 'key1'
                   // Add more key-value pairs as needed
               };
           
               // Send AJAX POST request
               $.ajax({
                   url: '{{route("generate")}}', // URL to send the AJAX request
                   method: 'POST', // HTTP method for the request
                   data: dataToSend, // Data to send along with the request
                   success: function(response){ // Callback function to handle successful response
                       if (window.editor) { // Check if CKEditor is initialized
                           console.log(response); // Log the response
                           var res = response;
                           window.editor.setData('<p>'+response+'</p>'); // Set the response data to CKEditor
                       } else {
                           console.error('CKEditor is not initialized.'); // Log an error if CKEditor is not initialized
                       }
                   },
